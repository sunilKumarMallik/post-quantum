          ...
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            ...
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0 ">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  const ImageSensorSection =
                    document.getElementById("ImageSensor");
                  if (ImageSensorSection) {
                    ImageSensorSection.scrollIntoView({
                      behavior: "smooth",
                    });
                  }
                }}
          ...
          <div className="flex items-center lg:w-3/5 mx-auto border-b pb-10 mb-10 border-gray-200 sm:flex-row flex-col">
            <div className="flex-grow sm:text-left text-center mt-6 sm:mt-0">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  const RemotesensingSection =
                    document.getElementById("Remotesensing");
                  if (RemotesensingSection) {
                    RemotesensingSection.scrollIntoView({
                      behavior: "smooth",
                    });
                  }
                }}
        ...
        <div className="container px-5 py-10 mx-auto ">
          ...
          >
            ...
            <div className="text-3xl not-italic font-bold leading-9 md:flex-grow md:w-1/2 lg:pl-5 md:pl-5 flex flex-col md:items-start md:text-left  font-heebo mt-5 text-white">
              <h2 className="mt-6 mb-2 text-red-500 "> Imaging Sensor:</h2>
              <div className="flex items-start mb-4">
                ...
                <p className="text-xl not-italic font-normal leading-relaxed text-white">
                  Quantum sensors leveraging quantum properties of light to
                  enhance the image quality with improved sensitivity.
                </p>
              </div>
          ...
          >
            ...
            <div className="text-3xl not-italic font-bold leading-9 md:flex-grow md:w-1/2 lg:pl-5 md:pl-5 flex flex-col md:items-start md:text-left  font-heebo mt-5 text-white">
              ...
              <div className="flex items-start mb-4">
                ...
                <p className="text-xl not-italic font-normal leading-relaxed text-white ">
                  Quantum radar is a concept that leverages quantum entanglement
                  to enhance the performance of radar systems. Traditional radar
                  systems use radio waves to detect objects and measure their
                  distance, speed, and direction. Quantum radar, on the other
                  hand, uses entangled photon pairs to achieve several
